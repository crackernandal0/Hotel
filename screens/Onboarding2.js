        ...
        <View style={Onboarding1Styles.contentContainer}>
          ...
          <View style={Onboarding1Styles.buttonContainer}>
            <View style={Onboarding1Styles.titleContainer}>
              <Text style={[Onboarding1Styles.title, { color: colors.text }]}>Enjoy Hassle-Free Bookings with</Text>
              <Text style={Onboarding1Styles.subTitle}>HOTELIS</Text>
            </View>

            <Text style={[Onboarding1Styles.description, { color: colors.text }]}>
              Find the best hotels at great prices, tailored just for you. With Hotelis, booking your dream accommodation is a breeze.
            </Text>
